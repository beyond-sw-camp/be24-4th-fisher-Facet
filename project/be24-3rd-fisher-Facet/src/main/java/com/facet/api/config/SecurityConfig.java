...
public class SecurityConfig {
    ...
    public SecurityFilterChain configure(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        ...
        http.authorizeHttpRequests(
                (auth) -> auth
                        .requestMatchers("/auction/mainList","/auction/list","/user/login", "/user/signup", "/user/verify").permitAll()
...
//                        .anyRequest().authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("https://www.facet7.kro.kr", "https://facet7.kro.kr", "http://10.10.10.100", "http://localhost:5173"));
